(function() {
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    var fEl = collection[keys[0]];
    var sEl = collection[keys[1]];
  ...
  _.extend = function(obj) {
    var argumentArr = Array.prototype.slice.call(arguments, 1);
  ...
  _.sortBy = function(collection, iterator) {
    ...
    for (var i = 1; i< collection.length; i++) {
      ...
      for (var j =0; j<collection.length-1; j++) {
        ...
        if (typeof iterator === 'string') {
          ...
          if (stevenPengfeisLessThan(iterator(array[j]), iterator(array[j-1]))) {
            array = swap(array, j);
          }
        }
    ...
    function swap(array, i) {
      var fvalue = array[i];
      var svalue = array[i-1];
      array[i-1] = fvalue;
      array[i] = svalue;
      return array;
    }
    function stevenPengfeisLessThan(a,b) {
      if (a < b || b === undefined) {
        return true;
      } else {
        return false;
